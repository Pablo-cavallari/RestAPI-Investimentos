package br.com.unicuritiba.projectinvestimento.controllers;
...
public class InvestimentoController {
	...
	public ResponseEntity<Investimento> saveInvestimento(
	...
	public ResponseEntity<Investimento> updateUser(@PathVariable long id,
			@RequestBody Investimento investimento) {
